<%@ Page Title="" Language="C#" MasterPageFile="~/FrontSite.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SensualHeritage.Index" %>
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal">
                            ...
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="../../images/hero/home-full-width-2.png" class="img-fluid" alt="Image">
                                        </div>
                                        <div class="image-two">
                                            <img src="../../images/hero/home-full-width-4.png" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        ...
                                        <div class="image-two">
                                            <img src="../../images/hero/home-full-width-1.png" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row banner-inner-box">
                        <div class="col-lg-6 col-md-6">
                            <div class="banner-images-one mt-30">
                                <a href="#" class="thumbnail">
                                    <img src="../../images/banners/bn-hf-1-570x340.png" class="img-fluid" alt="Banner images">
                                </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="banner-images-one mt-30">
                                <a href="#" class="thumbnail">
                                    <img src="../../images/banners/bn-hf-2-570x340.jpg" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="banner-title">
                        ...
                        <div class="col-lg-9">
                            <ul class="nav product-tab-menu justify-content-lg-end justify-content-center" role="tablist">
                                ...
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_02" role="tab">Accessories</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_03" role="tab">Chair</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_04" role="tab">Decoration</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_05" role="tab">Furniture</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_08" role="tab">Table</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row product-slider-active">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="../../images/product/1_9-300x300.jpg" class="img-fluid" alt="Product Images">
                            ...
                            <div class="row product-slider-active">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="../../images/product/10-300x300.jpg" class="img-fluid" alt="Product Images">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="product-details.html" class="product-thumbnail">
                                                <img src="../../images/product/11-300x300.jpg" class="img-fluid" alt="Product Images">
            ...
            <div class="offer-colection-area">
                <div class="section-space--ptb_120 bg-img" data-bg="assets/images/bg/banner_large.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 col-md-9">
                                        <div class="colection-info-wrap">
                                            ...
                                            <div class="button-box section-space--mt_60">
                                                <a href="#" class="text-btn-normal font-weight--bold font-lg-p">Discover now <i class="icon-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-9">
                            <ul class="nav product-tab-menu justify-content-lg-end justify-content-center" role="tablist">
                                <li class="tab__item nav-item active">
                                    <a class="nav-link active" data-toggle="tab" href="#tab_list_11" role="tab">All Products</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_12" role="tab">Accessories</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_13" role="tab">Chair</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_14" role="tab">Decoration</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_15" role="tab">Furniture</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_16" role="tab">Table</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="../../images/blog/8-570x370.jpg" class="img-fluid" alt="Blog Images">
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-6  col-sm-6 col-12">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="../../images/blog/9-570x370.jpg" class="img-fluid" alt="Blog Images">
                                    </a>
                                    <a href="#" class="btn-blog"> Read more </a>
                                </div>
                                <div class="blog-contents">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="../../images/blog/10-570x370.jpg" class="img-fluid" alt="Blog Images">
                                    </a>
                                    <a href="#" class="btn-blog"> Read more </a>
                                </div>
                                <div class="blog-contents">
                    ...
                    <div class="row brand-slider-active">
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="../../images/brand/partner1.jpg" class="img-fluid" alt="Brand Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="../../images/brand/partner2.jpg" class="img-fluid" alt="Brand Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="../../images/brand/partner3.jpg" class="img-fluid" alt="Brand Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="../../images/brand/partner4.jpg" class="img-fluid" alt="Brand Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-brand-item">
                                <a href="#"><img src="../../images/brand/partner5.jpg" class="img-fluid" alt="Brand Images"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-brand-item">
