<%@ Page Language="C#" MasterPageFile="~/FrontSite.Master" AutoEventWireup="true" CodeBehind="blog-details.aspx.cs" Inherits="SensualHeritage.blog_details" %>
                            ...
                            <div class="single-blog-item">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="../../images/blog/8-1170x672.jpg" class="img-fluid" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="blog-contents">
                                    ...
                                    <div class="post-author-box clearfix section-space--mt_60">
                                        <div class="post-author-avatar">
                                            <img src="../../images/blog/author.png" alt="" class="photo">
                                        </div>
                                    ...
                                    <div class="blog-relatel-post section-space--mt_60">
                                        <div class="navigation post-navigation">
                                            <a href="#" class="nav-links">
                                                <i class="icon-chevron-left"></i><span class="blog-nav nav-previous"><span class="d-text">Top 10 unique deco products 2020</span> <br><span class="title-nav">Previous</span></span>
                                            </a>
                                            <a href="#" class="nav-links post-next">
                                                <span class="blog-nav nav-next"><span class="d-text">Top 10 unique deco products 2020</span> <br><span class="title-nav">Next</span></span>
